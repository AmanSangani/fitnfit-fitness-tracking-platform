...
?>
                    <li class="navbar-item">
                        <a href="profile.php" class="navbar-link" data-nav-link>Hi,<?php
                        echo $username;
                        ?></a>
                    </li>
                    <?php
...
<?php
    if(!isset($_SESSION["email"])){
?>
<a href="./login/login.php" class="btn btn-primary">Sign Up</a>
<?php
    }
?>
<?php
...
?>
  ...
  <main>
    <article>
      ...
      <section id="course" style="margin-left: 400px;" class="section service" aria-label="service" data-section>
        <div class="container">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="womencourse.php" class="card-title">Women’s Course</a>
                </h3>
                ...
                <a href="womencourse.php" class="btn btn-secondary">
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="mencourse.php" class="card-title">Men’s Course</a>
                </h3>
                ...
                <a href="mencourse.php" class="btn btn-secondary">
                  <ion-icon name="arrow-forward"></ion-icon>
                </a>
  ...
  <footer class="footer">
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2023 Fitness Hub Made With
          <ion-icon name="heart" aria-hidden="true"></ion-icon> by
          <a href="#" class="copyright-link">TechTitans</a>
        </p>
